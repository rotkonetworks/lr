...
<body>
    ...
    <div style="margin: 20px 0;">
        <button type="button" onclick="deriveAddress()" style="width: 100%; padding: 15px; font-size: 14px;">
            DERIVE ACCOUNT
        </button>
    </div>
...
${cryptoBundle}
        ...
        // Initialize path info display
        updatePathInfo();
        document.getElementById('derivationMode').addEventListener('change', updatePathInfo);
    </script>
